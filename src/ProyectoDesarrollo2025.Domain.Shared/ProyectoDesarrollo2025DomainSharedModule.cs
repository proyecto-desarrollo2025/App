...
public class ProyectoDesarrollo2025DomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ProyectoDesarrollo2025DomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ProyectoDesarrollo2025Resource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ProyectoDesarrollo2025");

            options.DefaultResourceType = typeof(ProyectoDesarrollo2025Resource);
        ...
        {
            options.MapCodeNamespace("ProyectoDesarrollo2025", typeof(ProyectoDesarrollo2025Resource));
        });
    }
}

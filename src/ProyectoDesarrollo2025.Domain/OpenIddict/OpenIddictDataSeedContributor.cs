...
namespace ProyectoDesarrollo2025.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ProyectoDesarrollo2025") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ProyectoDesarrollo2025", DisplayName = "ProyectoDesarrollo2025 API", Resources = { "ProyectoDesarrollo2025" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["ProyectoDesarrollo2025_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["ProyectoDesarrollo2025_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ProyectoDesarrollo2025_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ProyectoDesarrollo2025_Swagger:RootUrl"]?.TrimEnd('/');
